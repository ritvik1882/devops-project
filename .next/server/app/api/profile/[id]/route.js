(()=>{var e={};e.id=233,e.ids=[233],e.modules={3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},7002:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>T,routeModule:()=>l,serverHooks:()=>c,workAsyncStorage:()=>m,workUnitAsyncStorage:()=>E});var a={};r.r(a),r.d(a,{GET:()=>d,PATCH:()=>p});var s=r(96559),i=r(48088),o=r(37719),n=r(32190),u=r(26346);async function d(e,t){let{id:r}=await t.params,a=u.w.getUserById(r);return a?n.NextResponse.json({user:a}):n.NextResponse.json({error:"User not found"},{status:404})}async function p(e,t){try{let{id:r}=await t.params,a=await e.json(),s=u.w.updateUserProfile(r,a);return n.NextResponse.json({user:s})}catch(e){return n.NextResponse.json({error:e.message||"Profile update failed"},{status:400})}}let l=new s.AppRouteRouteModule({definition:{kind:i.RouteKind.APP_ROUTE,page:"/api/profile/[id]/route",pathname:"/api/profile/[id]",filename:"route",bundlePath:"app/api/profile/[id]/route"},resolvedPagePath:"/home/ritvik/code/Blog-Sphere/src/app/api/profile/[id]/route.ts",nextConfigOutput:"",userland:a}),{workAsyncStorage:m,workUnitAsyncStorage:E,serverHooks:c}=l;function T(){return(0,o.patchFetch)({workAsyncStorage:m,workUnitAsyncStorage:E})}},10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},26346:(e,t,r)=>{"use strict";r.d(t,{w:()=>f});let a=require("node:crypto");var s=r.n(a);let i=require("node:fs");var o=r.n(i),n=r(76760),u=r.n(n);let d=require("better-sqlite3");var p=r.n(d);let l=u().join(process.cwd(),"data"),m=u().join(l,"blog-sphere.sqlite"),E=e=>{e.pragma("journal_mode = WAL"),e.pragma("foreign_keys = ON"),e.exec(`
