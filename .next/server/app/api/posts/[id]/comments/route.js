...
`;R();let L={getUserById(e){R();let t=c().prepare("SELECT id, name, email, avatar_url, bio, password FROM users WHERE id = ?").get(e);return t?S(t):null},loginWithEmail(e,t){R();let r=c().prepare("SELECT id, name, email, avatar_url, bio, password FROM users WHERE email = ?").get(e.toLowerCase().trim());if(!r||r.password!==t)throw Error("Invalid email or password.");return S(r)},signup(e){R();let t=c(),r=e.email.toLowerCase().trim();if(t.prepare("SELECT id FROM users WHERE email = ?").get(r))throw Error("An account with this email already exists.");let a=g();return t.prepare(`INSERT INTO users (id, name, email, password, avatar_url, bio, created_at)
       ...
       WHERE id = ?`).run(a,s,i,o,JSON.stringify(n),JSON.stringify(u),d??null,_(),e.id),this.getPostById(e.id)},deletePost(e){R();let t=c();t.transaction(()=>{t.prepare("DELETE FROM comments WHERE post_id = ?").run(e),t.prepare("DELETE FROM posts WHERE id = ?").run(e)})()},getCommentsByPostId:e=>(R(),c().prepare(`SELECT id, post_id, user_id, user_name, user_avatar_url, content, timestamp
         ...
         FROM comments
         WHERE id = ?`).get(a))},deleteComment(e,t){R();let r=c();r.transaction(()=>{let a=r.prepare("SELECT id, post_id FROM comments WHERE id = ?").get(t);a&&a.post_id===e&&(r.prepare("DELETE FROM comments WHERE id = ?").run(t),r.prepare("UPDATE posts SET comment_count = MAX(comment_count - 1, 0) WHERE id = ?").run(e))})()}}},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},76760:e=>{"use strict";e.exports=require("node:path")},78335:()=>{},88340:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>T,routeModule:()=>p,serverHooks:()=>c,workAsyncStorage:()=>l,workUnitAsyncStorage:()=>E});var a={};r.r(a),r.d(a,{GET:()=>d,POST:()=>m});var s=r(96559),i=r(48088),o=r(37719),n=r(32190),u=r(26346);async function d(e,t){let{id:r}=await t.params,a=u.w.getCommentsByPostId(r);return n.NextResponse.json({comments:a})}async function m(e,t){try{let{id:r}=await t.params,a=await e.json(),s=u.w.addComment({postId:r,userId:a.data?.userId,content:a.data?.content},a.user);return n.NextResponse.json({comment:s},{status:201})}catch(e){return n.NextResponse.json({error:e.message||"Failed to add comment"},{status:400})}}let p=new s.AppRouteRouteModule({definition:{kind:i.RouteKind.APP_ROUTE,page:"/api/posts/[id]/comments/route",pathname:"/api/posts/[id]/comments",filename:"route",bundlePath:"app/api/posts/[id]/comments/route"},resolvedPagePath:"/home/ritvik/code/Blog-Sphere/src/app/api/posts/[id]/comments/route.ts",nextConfigOutput:"",userland:a}),{workAsyncStorage:l,workUnitAsyncStorage:E,serverHooks:c}=p;function T(){return(0,o.patchFetch)({workAsyncStorage:l,workUnitAsyncStorage:E})}},96487:()=>{}};var t=require("../../../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),a=t.X(0,[447,580],()=>r(88340));module.exports=a})();