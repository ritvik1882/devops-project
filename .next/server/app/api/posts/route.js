(()=>{var e={};e.id=607,e.ids=[607],e.modules={3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},26346:(e,t,r)=>{"use strict";r.d(t,{w:()=>v});let a=require("node:crypto");var s=r.n(a);let i=require("node:fs");var o=r.n(i),n=r(76760),u=r.n(n);let d=require("better-sqlite3");var p=r.n(d);let l=u().join(process.cwd(),"data"),m=u().join(l,"blog-sphere.sqlite"),E=e=>{e.pragma("journal_mode = WAL"),e.pragma("foreign_keys = ON"),e.exec(`
...
`;R();let v={getUserById(e){R();let t=c().prepare("SELECT id, name, email, avatar_url, bio, password FROM users WHERE id = ?").get(e);return t?S(t):null},loginWithEmail(e,t){R();let r=c().prepare("SELECT id, name, email, avatar_url, bio, password FROM users WHERE email = ?").get(e.toLowerCase().trim());if(!r||r.password!==t)throw Error("Invalid email or password.");return S(r)},signup(e){R();let t=c(),r=e.email.toLowerCase().trim();if(t.prepare("SELECT id FROM users WHERE email = ?").get(r))throw Error("An account with this email already exists.");let a=g();return t.prepare(`INSERT INTO users (id, name, email, password, avatar_url, bio, created_at)
       ...
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0)`).run(a,e.title,e.excerpt,e.content,t.id,e.status,_(),JSON.stringify(e.categories),JSON.stringify(e.tags),e.imageUrl??null),this.getPostById(a)},updatePost(e){R();let t=c(),r=this.getPostById(e.id);if(!r)return;let a=e.title??r.title,s=e.excerpt??r.excerpt,i=e.content??r.content,o=e.status??r.status,n=e.categories??r.categories,u=e.tags??r.tags,d=void 0!==e.imageUrl?e.imageUrl:r.imageUrl;return t.prepare(`UPDATE posts
       SET title = ?, excerpt = ?, content = ?, status = ?, categories = ?, tags = ?, image_url = ?, last_modified_at = ?
       WHERE id = ?`).run(a,s,i,o,JSON.stringify(n),JSON.stringify(u),d??null,_(),e.id),this.getPostById(e.id)},deletePost(e){R();let t=c();t.transaction(()=>{t.prepare("DELETE FROM comments WHERE post_id = ?").run(e),t.prepare("DELETE FROM posts WHERE id = ?").run(e)})()},getCommentsByPostId:e=>(R(),c().prepare(`SELECT id, post_id, user_id, user_name, user_avatar_url, content, timestamp
         FROM comments
         WHERE post_id = ?
         ...
         FROM comments
         WHERE id = ?`).get(a))},deleteComment(e,t){R();let r=c();r.transaction(()=>{let a=r.prepare("SELECT id, post_id FROM comments WHERE id = ?").get(t);a&&a.post_id===e&&(r.prepare("DELETE FROM comments WHERE id = ?").run(t),r.prepare("UPDATE posts SET comment_count = MAX(comment_count - 1, 0) WHERE id = ?").run(e))})()}}},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},48156:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>T,routeModule:()=>l,serverHooks:()=>c,workAsyncStorage:()=>m,workUnitAsyncStorage:()=>E});var a={};r.r(a),r.d(a,{GET:()=>d,POST:()=>p});var s=r(96559),i=r(48088),o=r(37719),n=r(32190),u=r(26346);async function d(e){let t=new URL(e.url),r=t.searchParams.get("status"),a=t.searchParams.get("authorId"),s=u.w.getAllPosts({status:r??void 0,authorId:a??void 0});return n.NextResponse.json({posts:s})}async function p(e){try{let t=await e.json(),r=u.w.addPost(t.postData,t.author);return n.NextResponse.json({post:r},{status:201})}catch(e){return n.NextResponse.json({error:e.message||"Failed to create post"},{status:400})}}let l=new s.AppRouteRouteModule({definition:{kind:i.RouteKind.APP_ROUTE,page:"/api/posts/route",pathname:"/api/posts",filename:"route",bundlePath:"app/api/posts/route"},resolvedPagePath:"/home/ritvik/code/Blog-Sphere/src/app/api/posts/route.ts",nextConfigOutput:"",userland:a}),{workAsyncStorage:m,workUnitAsyncStorage:E,serverHooks:c}=l;function T(){return(0,o.patchFetch)({workAsyncStorage:m,workUnitAsyncStorage:E})}},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},76760:e=>{"use strict";e.exports=require("node:path")},78335:()=>{},96487:()=>{}};var t=require("../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),a=t.X(0,[447,580],()=>r(48156));module.exports=a})();